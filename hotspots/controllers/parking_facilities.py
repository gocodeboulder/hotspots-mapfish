...
from hotspots.model.parking_facilities import ParkingFacility
...
class ParkingFacilitiesController(BaseController):
    readonly = True # if set to True, only GET is supported

    def __init__(self):
        self.protocol = Protocol(Session, ParkingFacility, self.readonly)
    ...
    def index(self, format='json'):
        ...
        #
        # default_filter = create_default_filter(request, ParkingFacility)
        # filter = and_(default_filter, ParkingFacility.columname.ilike('%value%'))
