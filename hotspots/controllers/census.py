...
from hotspots.model.census import Census
...
class CensusController(BaseController):
    readonly = False # if set to True, only GET is supported

    def __init__(self):
        self.protocol = Protocol(Session, Census, self.readonly)
    ...
    def index(self, format='json'):
        ...
        #
        # default_filter = create_default_filter(request, Census)
        # filter = and_(default_filter, Census.columname.ilike('%value%'))
